...
#### Refactoring: [11_17_string_interpolation.patch](https://drive.google.com/file/d/1eOFcrGEjMJmDbbt_zGfk52OHXkQ9OBWj)
...
> PS: В последних версиях [JDK String Templates](https://habr.com/ru/companies/spring_aio/articles/825876/) пока присутствует как preview feature, ждем когда появится в релиза
----------------------
